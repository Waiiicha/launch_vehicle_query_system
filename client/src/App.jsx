...
const allManufacturers = [
  ...
  { value: '中科宇航 (CAS Space)', label: '中科宇航 (CAS Space)', country: '中国' },
  { value: '天兵科技 (Space Pioneer)', label: '天兵科技 (Space Pioneer)', country: '中国' },
  { value: '星际荣耀 (i-Space)', label: '星际荣耀 (i-Space)', country: '中国' },
  { value: '深蓝航天 (Deep Blue)', label: '深蓝航天 (Deep Blue)', country: '中国' },
  { value: '九州云箭 (JZYJ)', label: '九州云箭 (JZYJ)', country: '中国' },
  { value: '大航跃迁 (Dahang Yueqian)', label: '大航跃迁 (Dahang Yueqian)', country: '中国' },
  { value: '宇石空间 (Yushi Space)', label: '宇石空间 (Yushi Space)', country: '中国' },
  { value: 'SpaceX', label: 'SpaceX', country: '美国' },
  { value: 'NASA / 波音 (Boeing)', label: 'NASA / 波音 (Boeing)', country: '美国' },
  { value: '联合发射联盟 (ULA)', label: '联合发射联盟 (ULA)', country: '美国' },
  { value: '蓝色起源 (Blue Origin)', label: '蓝色起源 (Blue Origin)', country: '美国' },
  { value: '火箭实验室 (Rocket Lab)', label: '火箭实验室 (Rocket Lab)', country: '美国' },
  { value: 'Northrop Grumman', label: 'Northrop Grumman', country: '美国' },
  { value: 'Firefly', label: 'Firefly Aerospace', country: '美国' },
  { value: '阿丽亚娜空间 (Arianespace)', label: '阿丽亚娜空间 (Arianespace)', country: '欧洲' },
  { value: '赫鲁尼切夫 (Khrunichev)', label: '赫鲁尼切夫 (Khrunichev)', country: '俄罗斯' },
  { value: '日本宇航 (JAXA)', label: '日本宇航 (JAXA)', country: '日本' },
];
